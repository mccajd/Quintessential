...
const itemDB = {
	...
	'salt' : { 'name' : 'Salt', 'description': 'One of the three primes.\nUsed as a balancing agent for volatile processes,\nsuch as that of sublimation.', 'type': Item.ItemType.Prime, 'sprite' : 'res://assets/items/salt.png', 'id' : 2 },
	'sulfur' : { 'name' : 'Sulfur', 'description': 'One of the three primes.\nUsed as a combusting agent in the separation\nprocess of distillation when time is of the essence.', 'type': Item.ItemType.Prime, 'sprite' : 'res://assets/items/sulfur.png', 'id' : 3 },
	...
	'water_mote' : { 'name' : 'Water Mote', 'description': 'A modicum of Water.\nAscends into Air.\nSublimates into Fire.\nOffers little of value on its own, but may yield\ngreater when mixed with like kind.', 'type': Item.ItemType.Element, 'sprite' : 'res://assets/items/water_mote.png', 'id' : 11 },
	'fire_mote' : { 'name' : 'Fire Mote', 'description': 'A modicum of Fire.\nAscends into Water.\nSublimates into Earth.\nOffers little of value on its own, but may yield\ngreater when mixed with like kind.', 'type': Item.ItemType.Element, 'sprite' : 'res://assets/items/fire_mote.png', 'id' : 12 },
	'air_mote' : { 'name' : 'Air Mote', 'description': 'A modicum of Air.\nAscends into Earth.\nSublimates into Water.\nOffers little of value on its own, but may yield\ngreater when mixed with like kind.', 'type': Item.ItemType.Element, 'sprite' : 'res://assets/items/air_mote.png', 'id' : 13 },
	'earth_mote' : { 'name' : 'Earth Mote', 'description': 'A modicum of Earth.\nAscends into Fire.\nSublimates into Air.\nOffers little of value on its own, but may yield\ngreater when mixed with like kind.', 'type': Item.ItemType.Element, 'sprite' : 'res://assets/items/earth_mote.png', 'id' : 14 },
	...
	'wine' : { 'name' : 'Wine', 'description': 'An antique bottle of wine.\nAlways celebrated for its excellence, it now\nserves a different purpose.', 'type': Item.ItemType.World, 'sprite' : 'res://assets/items/wine.png', 'id' : 0 },
	'sea_creature' : { 'name' : 'Sea Creature', 'description': 'A gargantuan creature from depths untold.\nIts massive carcass must have once teemed\nwith body and soul.', 'type': Item.ItemType.World, 'sprite' : 'res://assets/items/creature.png', 'id' : 0 },
	...
	'anchor' : { 'name' : 'Anchor', 'description': 'A metal ship anchor found embedded in the\nbowels of a sea creature.\nWhether its placement there were incidental or\ndeliberate may never be known.', 'type': Item.ItemType.World, 'sprite' : 'res://assets/items/anchor.png', 'id' : 0 },
	...
	'lamp' : { 'name' : 'Lamp', 'description': 'A surprisingly well preserved lamp.\nSmells faintly of oil and ash.\n[i]Got a light?[/i]', 'type': Item.ItemType.World, 'sprite' : 'res://assets/items/lamp_token.png', 'id' : 4 },
